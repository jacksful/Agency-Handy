...
@section('content')
  ...
  <section id="hero" class="d-flex align-items-center">
    ...
    <div class="container d-flex flex-column align-items-center justify-content-center" data-aos="fade-up">
      <h1>Welcome to Agency Handy</h1>
      <h2>Make your business easy and faster</h2>
      <a href="#pricing" class="btn-get-started scrollto">Get Started</a>
      <img src="{{ asset('frontend/assets') }}/img/hero-img.png" class="img-fluid hero-img" alt="" data-aos="zoom-in" data-aos-delay="150">
    </div>
      ...
      <div class="container">
        ...
        <div class="row content">
          <div class="col-md-5" data-aos="fade-right" data-aos-delay="100">
            <img src="{{ asset('frontend/assets') }}/img/features-1.png" class="img-fluid" alt="">
          </div>
        ...
        <div class="row content">
          <div class="col-md-5" data-aos="fade-right">
            <img src="{{ asset('frontend/assets') }}/img/features-3.png" class="img-fluid" alt="">
          </div>
        ...
        <div class="row content">
          <div class="col-md-5 order-1 order-md-2" data-aos="fade-left">
            <img src="{{ asset('frontend/assets') }}/img/features-4.png" class="img-fluid" alt="">
          </div>
          <div class="col-md-7 pt-5 order-2 order-md-1" data-aos="fade-right">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
            <div class="box">
              ...
              <?php $items = explode(",",$plan->plan_details); ?>
              ...
              <div class="btn-wrap">
                <a href="{{ route('purchase.plan', ['id' => $plan->id]) }}" class="btn-buy">Buy Now</a>
              </div>
            </div>
          </div>
          @endforeach
