            ...
            <div class="card card-custom bgi-no-repeat card-stretch gutter-b" style="background-position: right top; background-size: 30% auto; background-image: url({{ asset('media/svg/shapes/abstract-4.svg') }})">
                ...
                <div class="card-body" style="position: relative">
                    <div style="display: flex; align-items:center">
                        <i class="bi bi-plug" style="font-size: 50px;"></i>
                        <p class="text-dark-75 font-weight-bolder font-size-h5 m-0 ml-2">{{ $plugin->name }}</p>
                    </div>
                    <a href="{{ route('download.file', $plugin->id) }}" class="btn btn-info btn-sm js-download mt-2">
