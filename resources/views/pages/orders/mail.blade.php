...
<body>
    <!-- Content Start -->
    <table cellpadding="0" cellspacing="0" cols="1" align="center" style="max-width: 600px;" style="border: 2px solid #fff">
        ...
        <tr>
            <td style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                <!-- Seperator Start -->
                <table align="center" cellpadding="0" cellspacing="0" cols="3" class="bordered-left-right">
                        ...
                        <td style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                            ...
                            <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0; "><strong>Payment Details:</strong><br/>
                                ...
                                <span style="width: 154px;">
                                    @if($order->payment_status)
                                        <span style="background: #129300; color: #fff; padding: 5px 10px; border-radius: 10px;">Paid</span>
                                    @else
                                        <span style="background: #c45102; color: #fff; padding: 5px 10px; border-radius: 10px;">Unpaid</span>
                                    @endif
                                </span>
                    ...
                    <tr align="center">
                        <td width="36" style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;"></td>
                        <td style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 16px; vertical-align: top;">
                            <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0;"><strong>Transaction reference: {{ $order->session_id }}</strong></p>
                            <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0;">Order date: {{ date('d-m-Y', strtotime($order->created_at)) }}</p>
                            <p style="color: #464646; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 22px; margin: 0;"><a target="_blank" href="{{ $order->invoice_hosted_url }}" class="btn btn-info">View Payment Receipt</a></p>
