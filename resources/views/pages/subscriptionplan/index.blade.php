    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">All Plan List</h3>
            </div>
        ...
        <div class="card-body">
            ...
            <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
                ...
                <tr>
                    ...
                    <th title="Field #3">Plan Description</th>
                    <th title="Field #4">Price</th>
                    <th title="Field #5">Payment Link</th>
                    <th title="Field #6">Active Status</th>
                </tr>
                </thead>
                <tbody>
                    @foreach($all_plans as $plan)
                        <tr>
                            ...
                            <td>{{ $plan->price; }}</td>
                            <td>{{ $plan->stripe_payment_link; }}</td>
                            <td align="right">
                                <span style="width: 154px;">
                                    @if($plan->is_active)
                                        <span class="label font-weight-bold label-lg  label-light-success label-inline">Active</span>
                                    @else
                                        <span class="label font-weight-bold label-lg  label-light-danger label-inline">Diactive</span>
                                    @endif
                                </span>
                            </td>
                        </tr>
